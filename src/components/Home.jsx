        ...
        items-center justify-center h-full px-4 md:flex-row">
            <div className='flex flex-col justify-center h-full'>
                ...
                <p className='text-gray-500 py-4 max-w-md'>
                    ...
                    elit. Nam sed tortor quis dolor gravida suscipit ac 
                    ac felis. Morbi pulvinar lacus eu maximus cursus. 
                    Suspendisse lacinia dictum purus. Suspendisse erat 
                    magna, faucibus non purus et, consectetur consequat 
                    odio. Nulla tempor posuere euismod.
                </p>
